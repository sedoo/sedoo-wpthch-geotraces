...
////////
add_filter( 'retrieve_password_message', 'sedoo_geotr_replace_reset_pass_mail', 10, 4 );
function sedoo_geotr_replace_reset_pass_mail( $message, $key, $user_login, $user_data ) {
