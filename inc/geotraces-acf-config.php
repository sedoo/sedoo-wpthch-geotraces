...
acf_add_local_field_group(array(
	'key' => 'group_5dcec9bbea0ab',
	'title' => 'Block : SSC members & Officers list',
	'fields' => array(
		array(
			'key' => 'field_5dcec9cae9e06',
			'label' => 'Title',
			'name' => 'geotraces_ssc_block_title',
			'type' => 'text',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'key' => 'field_5dcece036bd5e',
			'label' => 'Display title',
			'name' => 'geotraces_ssc_block_display_title',
			'type' => 'true_false',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'key' => 'field_5dceca0de9e07',
			'label' => 'Members type',
			'name' => 'geotraces_ssc_block_member_type',
			'type' => 'checkbox',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
